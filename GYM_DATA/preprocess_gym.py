...
from GYMDatasets import GYMMotionProcessor
...
def gendata(dataset_path, out_path, part='eval'):
    dataset = GYMMotionProcessor(
        '{}/{}_data.npy'.format(os.path.join(dataset_path), part),
        '{}/{}_label.pkl'.format(os.path.join(dataset_path), part),
        data_type='relative',
        t_length=max_frame,
        y_rotation=True,
        sampling='resize',
    ...
    f_position = open_memmap(
        ...
        dtype='float32',
        mode='w+',
        shape=(dataset.N, 2, max_frame, num_joint, max_body))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', default='data_50')
    ...
    for p in part:
        ...
        gendata(arg.dataset_path, out_path, part=p)